...
test('admin events', function (t) {
  ...
  nock('http://localhost:3000')
    .post('/hoodie/account/api/accounts')
    .reply(201, accountResponse)
    .get('/hoodie/account/api/accounts/abc1234').twice()
    .reply(200, accountResponse)
    .patch('/hoodie/account/api/accounts/abc1234')
    .reply(204)
    .delete('/hoodie/account/api/accounts/abc1234')
    .reply(204)
